...
If you are familiar with front-end development tools like Node.js and Vite, you can probably skip most of this lesson.

Otherwise, stick with us, and I'll explain everything in detail.

## Local server and build tools

In order to run our soon-to-be Three.js website, we need to run a local server.

We could have created an HTML file somewhere on our computer and double-clicked on it, but browsers limit the functionalities of websites opened like this for security reasons. As a result, we won’t be able to load Three.js, models, textures, etc.

The simplest solution to this problem is to use a "build tool" or "bundler".

### The state of build tools

There are many build tools available these days, such as Webpack, Vite, Gulp, Parcel, etc.

They all have various features with pros and cons, but we are going to use a very specific one in the following lessons.

Nowadays, the most popular build tool is Webpack. It’s widely used, has a great community, and you can do a lot with it. But while Webpack is the most popular, it’s not the most appreciated.
...
Vite is a build tool that allows us to write web code like HTML/CSS/JS, and it will build the final website. It’ll also do a bunch of things like optimizations, cache breaking, source mapping, running a local server, etc.
...
If the answer tells you that the node command isn’t recognized, then it’s not installed.
...
To install or update Node.js, go to [Node.js website](https://nodejs.org/en/), download the “LTS” and install it with the default settings.
...
Create a folder that will contain your website (try to stay organized, there are a bunch of lessons to come).
...
![000](https://github.com/Dhanush2468/THREEJS-CLASSES/assets/112778628/d3e2497f-f0c6-41ec-8cfb-d84706e15cf6)


You should notice three things:

1. A `node_modules/` folder has been created. This folder contains the project dependencies and you should never modify things inside that folder. Besides containing the `vite` dependency as the `vite/` folder, it also features the other dependencies that are being used by `vite`.
2. The `package.json` has been updated and now contains an array of dependencies written in the "dependencies" properties with numbers corresponding to the version with a level of tolerance.
3. A `package-lock.json` has been written and contains information about the dependencies and the exact versions that have been installed in your project without tolerance.
...
![001](https://github.com/Dhanush2468/THREEJS-CLASSES/assets/112778628/5eebf059-45a0-4c55-abae-d4d52a05890d)
...
![002](https://github.com/Dhanush2468/THREEJS-CLASSES/assets/112778628/3add4fa6-7635-4c77-9cec-05e159f234b5)
...
![003](https://github.com/Dhanush2468/THREEJS-CLASSES/assets/112778628/c178cd35-93c9-4b98-a4b5-0afbb8610ac3)
...
![004](https://github.com/Dhanush2468/THREEJS-CLASSES/assets/112778628/9f3fcfa3-8aaa-4f74-8bdb-0d3f246e9cce)
...
![005](https://github.com/Dhanush2468/THREEJS-CLASSES/assets/112778628/924de93c-432e-4601-830f-f9634076ac30)
...
![006](https://github.com/Dhanush2468/THREEJS-CLASSES/assets/112778628/73055ea8-f228-41fd-bd46-3c84cbd6e6b2)
...
LINK OF VIDEO:
```
https://threejs-journey.com/assets/lessons/3/007.mp4
...
```
![008](https://github.com/Dhanush2468/THREEJS-CLASSES/assets/112778628/8f22209f-2bf2-4d4a-b8e9-2aff0f9951b9)
...
scene.add(camera)
```
![009](https://github.com/Dhanush2468/THREEJS-CLASSES/assets/112778628/50c9759e-3ff0-4856-bc81-8d5ec9b57eaf)
